...
if (defined $makefiles{'clangcl'}) {
    ...
    &splitline("CFLAGS = /nologo /W3 /O1 " .
               ...
               "/D_CRT_SECURE_NO_WARNINGS /DONTHESPOT /DSUPPORT_CYGTERM")."\n".
...
if (defined $makefiles{'vc'}) {
    ...
    print
      ...
      "CFLAGS = /nologo /W3 /O1 " .
      (join " ", map {"-I$dirpfx$_"} @srcdirs) .
      " /D_WINDOWS /D_WIN32_WINDOWS=0x500 /DWINVER=0x500 /D_CRT_SECURE_NO_WARNINGS /DONTHESPOT /DSUPPORT_CYGTERM\n".
      "LFLAGS = /incremental:no /dynamicbase /nxcompat\n".
...
if (defined $makefiles{'vstudio10'} || defined $makefiles{'vstudio12'} || defined $makefiles{'vstudio15'} || defined $makefiles{'vstudio17'}) {
    ...
    sub create_vs_project {
        ...
        print
            ...
            "      <PreprocessorDefinitions>WIN32;NDEBUG;_WINDOWS;POSIX;_CRT_SECURE_NO_WARNINGS;_CRT_NONSTDC_NO_DEPRECATE;ONTHESPOT;SUPPORT_CYGTERM;%(PreprocessorDefinitions)</PreprocessorDefinitions>\n" .
            ...
            "      <AdditionalIncludeDirectories>..\\..\\../;" . (join ";", map {"..\\..\\$dirpfx$_"} @srcdirs) . ";%(AdditionalIncludeDirectories)</AdditionalIncludeDirectories>\n" .
            "      <PreprocessorDefinitions>WIN32;_DEBUG;_WINDOWS;POSIX;_CRT_SECURE_NO_WARNINGS;_CRT_NONSTDC_NO_DEPRECATE;ONTHESPOT;SUPPORT_CYGTERM;%(PreprocessorDefinitions)</PreprocessorDefinitions>\n" .
